...
index_path = model.index(index_name="index_"+model_name, collection=passages, document_ids=passage_ids, max_document_length=512) # document length maximized for BERT
