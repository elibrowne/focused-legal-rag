...
if __name__ == "__main__":
    ...
    index_path = model.index(index_name="index_"+model_name, collection=passages, document_ids=passage_ids, bsize=8, max_document_length=512) # document length maximized for BERT
    ...
    metrics(1, save_file, model)
    metrics(10, save_file, model) # we also want to return MRR here
    metrics(100, save_file, model)
    metrics(1000, save_file, model)
