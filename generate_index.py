...
if __name__ == "__main__":
    model_name = ".ragatouille/colbert/none/2024-07/08/15.11.00/checkpoints/colbert" # substitute with model being employed!
    ...
    index_path = model.index(index_name="index_legalbertft_VALIDATION", collection=passages, document_ids=passage_ids, bsize=8, max_document_length=512) # document length maximized for BERT
