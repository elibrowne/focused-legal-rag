...
if __name__ == "__main__":
    ...
    index_name = ".ragatouille/colbert/indexes/index_legalbertft_VALIDATION/"  # substitute with model being employed!
    ...
    k = 1000 
    save_file = "evaluation_legalcolbert_ft.txt" # change this when testing different models
