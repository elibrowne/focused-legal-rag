...
if __name__ == "__main__":
    ...
    index_name = ".ragatouille/colbert/indexes/baseColBERT_index/"  # substitute with model being employed!
    ...
    k = 1000 
    save_file = "baseColBERT_eval.txt" # change this when testing different models
