...
if __name__ == "__main__":
    ...
    trainer.prepare_training_data(raw_data=data, all_documents=passages, data_out_path="./val_data/", mine_hard_negatives = False, num_new_negatives = 0) # this should automatically mine hard negatives and save them if the custom install is working 
